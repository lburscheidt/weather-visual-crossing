...
export async function getCurrentData(weatherLocation, unitgroup) {
...
export async function getWeeklyData(weatherLocation, unitgroup) {
	const response = await fetch(
...
export async function getTomorrowData(weatherLocation, unitgroup) {
	const response = await fetch(`
...
export async function getHourlyData(weatherLocation, unitgroup) {
	const response = await fetch(
